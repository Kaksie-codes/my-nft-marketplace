...
const ProfilePage = () => {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      // Fetch up to 3 NFTs for each collection so we can show real thumbnails
...
//                   : <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
//                       {collections.map(col => (
//                         <TrendingCollectionCard key={col._id} bannerImg="/nft-placeholder.png"
//                           thumbnails={[]} count={col.nftCount ?? 0} title={col.name} creatorName={displayName} />
//                       ))}
//                     </div>
//               )}
