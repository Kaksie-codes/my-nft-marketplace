...
const CollectionSchema = new Schema(
  {
    ...
    // ── Access control fields ── kept in sync by collectionIndexer
    // PublicMintToggled  → updates publicMintEnabled
    // CollaboratorUpdated → adds/removes from collaborators array
    publicMintEnabled: { type: Boolean, default: false, index: true },
